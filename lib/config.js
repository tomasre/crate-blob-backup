...
function config(configFile) {
    ...
    // start the crate connection
    this.crate = require('node-crate');
    this.crate.connect(this.options.hosts.join(' '));
    ...
    if (!this.options.parallelCount) {
        this.options.parallelCount = DEFAULT_OPTIONS.parallelCount;
    }
}
